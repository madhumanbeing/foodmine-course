  ...
  getAll():Food[]{
    return [
      {        
        ...
        serves: '8',
        ingredients: ['2kg Beef Brisket', 'Dry rub', '4 tbsp dark brown sugar',
      ...
      {        
        ...
        cookTime: '30 min',
        serves: '8',
        ingredients: ['1 bunch coriander, chopped',
      ...
      {        
        ...
        steps: [
          ...
          "Preheat oven to 180C. Prepare oven tray lined with baking paper then add eggs after lightly beating.",
        ],
      },
      {        
        title: 'Khao Soi',
      ...
      },
      {
        ...
        cookTime: '50 min',
        serves: '4',
        ingredients: ['25 wontons wrappers',
          '1/2 cup firm tofu',
      ...
      },
      {
        ...
        cookTime: '40 mins',
        serves: '8',
        ingredients: ['425gm tin blackbeans',
          '3 large eggs',
